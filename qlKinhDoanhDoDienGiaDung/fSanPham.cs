...
namespace qlKinhDoanhDoDienGiaDung
{
    public partial class frmSanPham : Form
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            sql = "INSERT INTO SanPham VALUES (N'" + txtMaSanPham.Text.Trim() + "', N'" + cboMaNhaCungCap.Text.Trim() + "', N'" + txtTenSanPham.Text.Trim() + "', N'" + txtSoLuong.Text.Trim() + "', N'" + txtDonGiaBan.Text.Trim() + "')";
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE SanPham SET MaNCC = N'" + cboMaNhaCungCap.Text.Trim() + "', TenSP = N'" + txtTenSanPham.Text.Trim() + "', SoLuong = N'" + txtSoLuong.Text.Trim() + "', DonGiaBan = N'" + txtDonGiaBan.Text.Trim() + "' WHERE MaSP = N'" + txtMaSanPham.Text.Trim() + "'";
